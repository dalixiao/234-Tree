...
public:
    struct Node{
        Node(int E[], int  C[], int Oc, Node* p0, Node* p1, Node* p2, Node* p3, Node* p4){
            for(int i=0; i<4; i++){
                element[i] = E[i];
                counter[i] = C[i];
            }
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Node* Merge_Split_If_Rich(Node* Root_Original,Node* Root_Returning){
        ...
        int InsertingElement = Root_Returning->element[0];
